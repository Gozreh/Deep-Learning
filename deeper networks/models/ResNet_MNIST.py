...
# train model
train_hist = pf.train_model(model, train_loader, val_loader, criterion, optimiser, epochs, batch_size, 'ResNet34_train_MNIST')

# show training statistics
pf.loss_train_hist(train_hist, save=True, path='./stats/' + 'ResNet34_loss_MNIST' + '.png')
pf.acc_train_hist(train_hist, save=True, path='./stats/' + 'ResNet34_acc_MNIST' + '.png')
