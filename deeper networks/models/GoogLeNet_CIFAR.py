...
model = torchvision.models.googlenet(pretrained=False).to(device)
...
# train model
train_hist = pf.train_model_aux(model, train_loader, val_loader, criterion, optimiser, epochs, batch_size, 'GoogLeNet_train_CIFAR')

# show training statistics
pf.loss_train_hist(train_hist, save=True, path='./stats/' + 'GoogLeNet_loss_CIFAR' + '.png')
pf.acc_train_hist(train_hist, save=True, path='./stats/' + 'GoogLeNet_acc_CIFAR' + '.png')
