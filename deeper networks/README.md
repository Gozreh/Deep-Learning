# Deeper networks for image recognition.
...
Project_funtions.py contains the functions needed to train the various models. Evalutation.py is used to evaluate the best models for each model type.
