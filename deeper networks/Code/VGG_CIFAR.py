...
# train model
train_hist = pf.train_model(model, train_loader, val_loader, criterion, optimiser, epochs, batch_size, 'VGG16_train_CIFAR')

# show training statistics
pf.loss_train_hist(train_hist, save=True, path='./stats/' + 'VGG16_loss_CIFAR' + '.png')
pf.acc_train_hist(train_hist, save=True, path='./stats/' + 'VGG16_acc_CIFAR' + '.png')
